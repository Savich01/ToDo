...
const taskList = document.querySelector('.main-container--list');
...
function addTask(event) {
    ...
    const taskHTML = `
                <li class="main-container--list-link">
                        ...
                        <span class="main-text main-text--done">lorem</span>
                    </li>
    ...
    taskBlock.insertAdjacentHTML('beforeend', taskList);
