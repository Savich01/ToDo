...
function addTask(event) {
    ...
    const taskHTML = `
                <ul class='main-container--list' class="main-container--list">
                    <li id='${newTask.id}' class="main-container--list-link">
                        <input class="main-checked" type="checkbox" data-action = "done">
                        <span class="${cssClass}">${newTask.text}</span>
                    </li>
                    <button id='${newTask.id}' class="main--list-btn" data-action = "delete">
                        х
                    </button>
               </ul>
              `;
...
function deleteTask(event){
    ...
    if(event.target.dataset.action === 'delete'){
        ...
        const taskTitle2 = parenNode.querySelector('.main--list-btn');
