...
const add = document.querySelector('.main-btn1').addEventListener('click', () => {
    render(tasks)
});
const btnAll = document.querySelector('.main-btn1');
...
arrActive.addEventListener('click', function(){
    let taskArr = [];
...
const arrActive = document.querySelector('.main-btn2');
